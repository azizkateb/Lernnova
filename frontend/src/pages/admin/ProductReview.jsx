...
import { Search, ChevronLeft, ChevronRight, ExternalLink, Package, AlertCircle, FileText } from 'lucide-react';
                  ...
                  >
                        ...
                        <div className="min-w-0">
                          ...
                          {product.short_description && (
                            <p className="text-[12px] text-slate-400 truncate mt-0.5 max-w-[240px]">
                              {product.short_description.length > 60
                                ? product.short_description.slice(0, 60) + '…'
                                : product.short_description}
                            </p>
                          )}
                        </div>
                    ...
                    <td className="px-6 py-4 hidden lg:table-cell">
                      <div className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400">
                        ...
                        <span>{product._count?.files ?? 0}</span>
                      </div>
                    </td>
