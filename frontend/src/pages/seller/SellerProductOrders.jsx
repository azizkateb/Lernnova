    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <select
          ...
          className="w-full sm:w-auto px-3 py-2.5 text-sm rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-400 transition cursor-pointer"
        >
          ...
          <div className="md:hidden divide-y divide-slate-100 dark:divide-slate-700/60">
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  {order.order_status === 'new' ? (
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-200 px-3 py-2 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-50 dark:border-emerald-700/50 dark:text-emerald-300 dark:hover:bg-emerald-900/20"
                    >
            ...
            {!loading && !error && filteredOrders.length === 0 ? (
              <div className="px-6 py-10">
                <EmptyState
                  icon={ShoppingBag}
                  title={t('pages.seller.productOrders.empty.title', 'No product orders found')}
                  description={t('pages.seller.productOrders.empty.description', 'You have not received any product orders yet.')}
                />
              </div>
            ) : null}
          </div>
